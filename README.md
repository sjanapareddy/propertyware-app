...
specified modules.
 * **propertyware-app-test-api** - will contain the backend project
 * **propertyware-app-test-ui** - will contain the frontend project

Then, we need to create the modules using Maven Build Tool. We add the modules in the main **pom.xml**

```
<modules>
   <module>propertyware-app-test-api</module>
   <module>propertyware-app-test-ui</module>
</modules>
```
...
In the **propertyware-app-test-ui** module we implement the parent section

```
<parent>
   <groupId>com</groupId>
   <artifactId>propertyware-app</artifactId>
   <version>0.0.1-SNAPSHOT</version>
</parent>

<artifactId>propertyware-app-test-api</artifactId>
<version>0.0.1-SNAPSHOT</version>
```
           ...
           <executions>
               <execution>
                   ...
                   <configuration>
                       ...
                       <resources>
                           <resource>
                               <directory>${project.parent.basedir}/propertyware-app-test-ui/dist/frakton/</directory>
                           </resource>
                       </resources>
                   </configuration>
               </execution>
...
<dependencies>
   <dependency>
       <groupId>com</groupId>
       <artifactId>propertyware-app-test-ui</artifactId>
...
directory. The **dist/propertyware-app** folder is used to be placed inside the build output.

```
<resources>
   <resource>
       <directory>./dist/propertyware-app</directory>
